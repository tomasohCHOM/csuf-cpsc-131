...
class GroceryItemDatabase
{
  ...
  private:
    ...
    std::vector<GroceryItem> _dataStore;                                        // data store in standardized vector
    GroceryItem * find( size_t currentIndex, const std::string & isbn );        // find() private helper function
    /////////////////////// END-TO-DO (2) ////////////////////////////
};
