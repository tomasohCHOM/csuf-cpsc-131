...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (1) //////////////////////////////
      ...
      ///
    GroceryStore groceryStore("GroceryStoreInventory.dat");
    /////////////////////// END-TO-DO (1) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
    GroceryStore::GroceryItemsSold todaysSales = groceryStore.ringUpCustomers(shoppingCarts, std::cout);
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// store's inventory.
      ///
    GroceryStore::Inventory_DB & inventory = groceryStore.inventory();
    ...
    groceryStore.reorderItems(todaysSales, std::cout);
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
